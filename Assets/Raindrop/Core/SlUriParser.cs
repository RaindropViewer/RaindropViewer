...
namespace Raindrop
{
    public class SlUriParser
    {
        ...
        private void ExecuteLinkRegionUri(Match match)
        {
            ...
            //todo: push map to user view and show the place!
            //instance.MainCanvas.cm.pushCanvas();
            //instance.MainCanvas.WorldMap.DisplayLocation(name, x, y, z);
        }
        ...
        private void ExecuteLinkAgent(Match match)
        {
            ...
            //todo: open the avatar screen and show the user the avatar in question!
            //RaindropInstance.GlobalInstance.MainForm.ShowAgentProfile(instance.Names.Get(agentID), agentID);
        }
        ...
        private void ExecuteLinkGroup(Match match)
        {
            ...
            //todo: push group interface to user view and show!
