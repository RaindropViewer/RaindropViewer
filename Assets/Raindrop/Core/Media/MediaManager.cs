...
namespace Raindrop.Media
{
    public class MediaManager : MediaObject
    {
        ...
        public MediaManager(RaindropInstance instance)
        {
            ...
            listenerThread = new System.Threading.Thread(ListenerUpdate)
            {
                IsBackground = true,
                Name = "ListenerThread"
            };
