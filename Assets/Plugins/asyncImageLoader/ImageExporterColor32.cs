...
//     public class ImageExporterColor32 : IDisposable
//     {
...
//
//         JobHandle _finalJob;
//         public ImageExporterColor32(Color32[] in_bitmap, 
//             int width,
//             int height,
//             
...
//                     getAndSet_image_parameters_from_T2D(in_bitmap);
//
//                     // 1. get input image bytes.
//                     using (NativeArray<byte> imagebitmap = in_bitmap.GetRawTextureData<byte>())
//                     {
//                         unsafe
//                         {
//                             // convert RGB (texture2d.getrawtexturedata ) to BGR (FreeIMage.ConvertFromRawBits require Format).
//                             ProcessRawTextureData(imagebitmap, in_bitmap.mipmapCount);   
//                             _finalJob.Complete();
//
